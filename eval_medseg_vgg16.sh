...
srun python main.py --configs configs/eval_medseg_pan_vgg16_0.yml
srun python main.py --configs configs/eval_medseg_pan_vgg16_1.yml
srun python main.py --configs configs/eval_medseg_pan_vgg16_2.yml
srun python main.py --configs configs/eval_medseg_pan_vgg16_3.yml
srun python main.py --configs configs/eval_medseg_pan_vgg16_4.yml
...
srun python main.py --configs configs/eval_medseg_deeplabv3_vgg16_0.yml
srun python main.py --configs configs/eval_medseg_deeplabv3_vgg16_1.yml
srun python main.py --configs configs/eval_medseg_deeplabv3_vgg16_2.yml
srun python main.py --configs configs/eval_medseg_deeplabv3_vgg16_3.yml
srun python main.py --configs configs/eval_medseg_deeplabv3_vgg16_4.yml
srun python main.py --configs configs/eval_medseg_deeplabv3plus_vgg16_0.yml
srun python main.py --configs configs/eval_medseg_deeplabv3plus_vgg16_1.yml
srun python main.py --configs configs/eval_medseg_deeplabv3plus_vgg16_2.yml
srun python main.py --configs configs/eval_medseg_deeplabv3plus_vgg16_3.yml
srun python main.py --configs configs/eval_medseg_deeplabv3plus_vgg16_4.yml
