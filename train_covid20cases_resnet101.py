...
ls=["python main.py --configs configs/train_covid20cases_unet_resnet101_fold0.yml",
...
"python main.py --configs configs/train_covid20cases_unetplusplus_resnet101_fold0.yml",
