...
srun python main.py --configs configs/eval_ricord1a_pan_resnet50_0.yml
srun python main.py --configs configs/eval_ricord1a_pan_resnet50_1.yml
srun python main.py --configs configs/eval_ricord1a_pan_resnet50_2.yml
srun python main.py --configs configs/eval_ricord1a_pan_resnet50_3.yml
srun python main.py --configs configs/eval_ricord1a_pan_resnet50_4.yml
...
srun python main.py --configs configs/eval_ricord1a_deeplabv3_resnet50_0.yml
srun python main.py --configs configs/eval_ricord1a_deeplabv3_resnet50_1.yml
srun python main.py --configs configs/eval_ricord1a_deeplabv3_resnet50_2.yml
srun python main.py --configs configs/eval_ricord1a_deeplabv3_resnet50_3.yml
srun python main.py --configs configs/eval_ricord1a_deeplabv3_resnet50_4.yml
srun python main.py --configs configs/eval_ricord1a_deeplabv3plus_resnet50_0.yml
srun python main.py --configs configs/eval_ricord1a_deeplabv3plus_resnet50_1.yml
srun python main.py --configs configs/eval_ricord1a_deeplabv3plus_resnet50_2.yml
srun python main.py --configs configs/eval_ricord1a_deeplabv3plus_resnet50_3.yml
srun python main.py --configs configs/eval_ricord1a_deeplabv3plus_resnet50_4.yml
