...
srun python main.py --configs configs/eval_medseg_unetplusplus_resnext50_32x4d_5.yml
srun python main.py --configs configs/eval_medseg_unetplusplus_resnext50_32x4d_6.yml
srun python main.py --configs configs/eval_medseg_unetplusplus_resnext50_32x4d_7.yml
