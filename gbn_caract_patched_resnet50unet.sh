...
#SBATCH -t 7-00:00:00
#SBATCH -c 8
#SBATCH -o /home/bakrinski/segtool/logs/gbn_caract_patched_resnet50unet_log.out
...
#SBATCH --gres=gpu:1
#SBATCH -e /home/bakrinski/segtool/logs/gbn_caract_patched_resnet50unet_error.out
